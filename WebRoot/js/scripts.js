...
function createMap(){
    ...
    var point = new BMap.Point(117.252904,39.076468);//定义一个中心点坐标
...
//标注点数组
var markerArr = [{title:"",content:"",point:"117.252962|39.076993",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ];
//创建marker
function addMarker(){
...
$(document).ready(function(){
    KE.show({
        ...
        urlType : 'domain',
        cssPath : 'css/ke.css',
        imageUploadJson : '<%=basePath%>fileUpDown/onUploadImg',
